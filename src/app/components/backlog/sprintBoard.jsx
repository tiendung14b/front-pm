...
export default function SprintBoard({ showfilter }) {
  ...
  return (
    <div className="w-full py-3 px-4 bg-[#00000015] rounded-[5px]">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <p className="text-black font-[600] text-[12px]">Sprint 1</p>
            <img
      ...
      <div
        className={`mt-4 py-3 px-5 hover:bg-[#546FFF60] rounded-[5px] cursor-pointer w-fit ${
          !show && "hidden"
        }`}
      >
